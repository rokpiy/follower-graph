    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-100 hover:opacity-100 border-white/20',
        ),
        ...
        day_outside:
          'day-outside text-white/40 opacity-50 aria-selected:bg-white/10 aria-selected:text-white/40 aria-selected:opacity-30',
